...
from app.models import LinkedInProfile, CompanySummaryWithRating, GlassdoorProfile, CrunchbaseProfile
import json
...
async def summarize_company(company_name: str, linkedin: LinkedInProfile, glassdoor: GlassdoorProfile, crunchbase: CrunchbaseProfile) -> CompanySummaryWithRating:
